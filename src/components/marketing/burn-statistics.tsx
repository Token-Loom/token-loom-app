...
function StatCard({ title, value, cardGradient }: { title: string; value: string | null; cardGradient: string }) {
  return (
    <Card className='group relative overflow-hidden border-0 bg-[#1A1B23] p-6 transition-all duration-500'>
      ...
      <div className='relative'>
        ...
        <div className='mt-2'>
          {value ? (
            <p className='text-2xl font-semibold text-[#E6E6E6]'>{value}</p>
          ) : (
